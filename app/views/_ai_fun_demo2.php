...
<h2>Demo 2</h2>
<h2 class='demo2'>Learning Biometric Data</h2>
<div style="width:300px"><canvas id="myChart2" width="300" height="300" style></canvas></div>
<h2>Training input:</h2>
<span id="input2"></span>
<h2>Diagnosis of user state:</h2>
<span id="output2"></span>
<h2>Number of training data applied:</h2>
<span id="count2"></span>
<h2>Neural Network accuracy:</h2>
<span id="probability2"></span>

<h3>Inputs: 5</h3>
<p>3 valid, and 2 variable arbitrary inputs.</p>
<h3>Hidden layers: 1 (22 neurons)</h3>
<h3>Output layer: 1 (binary)</h3>
<p>This demo shows a local device (in-browser) neural network learning to recognise high/low anxiety state based on blood pressure and heart rate, variable with a pre-existing medical condition. The problem is extremely simple. This demo uses an ultra-small single hidden layer of only 22 neurons to smooth the visualization. In reality, this software can learn the solution to this problem with 95% accuracy in less than 40 training examples.</p>
